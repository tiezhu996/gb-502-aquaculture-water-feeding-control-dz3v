...
type ControlExecution struct {
	...
	Recommendation     *Recommendation           `gorm:"constraint:OnUpdate:CASCADE,OnDelete:RESTRICT" json:"recommendation,omitempty"`
	RecommendationCode string                    `gorm:"size:20" json:"recommendationCode"`
